    ...
    try {
        ...
        const transformedEntries = result.rows.map(entry => {
            ...
            return {
                ...
                // Individual meal nutrition fields (for fallback calculation)
                breakfast_calories: entry.breakfast_calories || null,
                breakfast_protein: entry.breakfast_protein || null,
                breakfast_carbs: entry.breakfast_carbs || null,
                breakfast_fiber: entry.breakfast_fiber || null,
                breakfast_fat: entry.breakfast_fat || null,
                lunch_calories: entry.lunch_calories || null,
                lunch_protein: entry.lunch_protein || null,
                lunch_carbs: entry.lunch_carbs || null,
                lunch_fiber: entry.lunch_fiber || null,
                lunch_fat: entry.lunch_fat || null,
                dinner_calories: entry.dinner_calories || null,
                dinner_protein: entry.dinner_protein || null,
                dinner_carbs: entry.dinner_carbs || null,
                dinner_fiber: entry.dinner_fiber || null,
                dinner_fat: entry.dinner_fat || null,
                snack_calories: entry.snack_calories || null,
                snack_protein: entry.snack_protein || null,
                snack_carbs: entry.snack_carbs || null,
                snack_fiber: entry.snack_fiber || null,
                snack_fat: entry.snack_fat || null,
                notes: entry.notes,
