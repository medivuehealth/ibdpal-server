    ...
    try {
        ...
        const transformedEntries = result.rows.map(entry => {
            ...
            return {
                ...
                blood_present: entry.blood_present || null,
                mucus_present: entry.mucus_present || null,
                pain_severity: entry.pain_severity || null,
                pain_location: entry.pain_location || null,
                urgency_level: entry.urgency_level || null,
                bristol_scale: entry.bristol_scale || null,
                hydration: entry.hydration_level || null,
                // Direct nutrition fields (calculated by server)
                ...
                // Individual meal nutrition fields (for fallback calculation) - convert to numbers
                breakfast_calories: parseFloat(entry.breakfast_calories) || null,
                breakfast_protein: parseFloat(entry.breakfast_protein) || null,
                breakfast_carbs: parseFloat(entry.breakfast_carbs) || null,
                breakfast_fiber: parseFloat(entry.breakfast_fiber) || null,
                breakfast_fat: parseFloat(entry.breakfast_fat) || null,
                lunch_calories: parseFloat(entry.lunch_calories) || null,
                lunch_protein: parseFloat(entry.lunch_protein) || null,
                lunch_carbs: parseFloat(entry.lunch_carbs) || null,
                lunch_fiber: parseFloat(entry.lunch_fiber) || null,
                lunch_fat: parseFloat(entry.lunch_fat) || null,
                dinner_calories: parseFloat(entry.dinner_calories) || null,
                dinner_protein: parseFloat(entry.dinner_protein) || null,
                dinner_carbs: parseFloat(entry.dinner_carbs) || null,
                dinner_fiber: parseFloat(entry.dinner_fiber) || null,
                dinner_fat: parseFloat(entry.dinner_fat) || null,
                snack_calories: parseFloat(entry.snack_calories) || null,
                snack_protein: parseFloat(entry.snack_protein) || null,
                snack_carbs: parseFloat(entry.snack_carbs) || null,
                snack_fiber: parseFloat(entry.snack_fiber) || null,
                snack_fat: parseFloat(entry.snack_fat) || null,
                notes: entry.notes,
